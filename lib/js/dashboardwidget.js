...
function DashboardWidgetClass(element)
{
	...
	this.initialize = function()
	{
		if (!this.element.attr('static'))
		{
			this.element.html(
				...
				+     '<a class="button" action="gotomodule" href="javascript:;" title="&modules.dashboard.dashboard.GoToModuleEllipsis;"><img src="{UIHOST}/icons/small/search.png"/></a>'
				+     '<a class="button" action="refresh" href="javascript:;" title="&modules.dashboard.dashboard.Refresh;"><img src="{UIHOST}/icons/small/refresh.png"/></a>'
				+     '<a class="button" action="toggle" href="javascript:;" title="&modules.dashboard.dashboard.Toggle;"><img src="{UIHOST}/icons/small/toggle.png"/></a>'
				+   '</div>'
				+ '</div>'
	...
	this.onLoad = function(data)
	{
		...
		else
		{
			this.setTitle(
				...
				'{UIHOST}/icons/small/unknown.png'
			);
	...
	this.toggle = function()
	{
		...
		this.buttons.filter('[action="toggle"]').children('img').attr('src', '{UIHOST}/icons/small/toggle'+(this.collapsed ? '-expand' : '')+'.png');
...
function widgetToggleElement(imgId, elementId)
{
	...
	if (collapsed == "true")
	{
		...
		image.attr('src', '{UIHOST}/icons/small/toggle_expand.png')
		element.slideDown('fast');
	}
	else
	{
		image.attr('collapsed', "true");
		image.attr('src', '{UIHOST}/icons/small/toggle.png')
